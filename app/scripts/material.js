...
MaterialTabs.prototype.CssClasses_ = {
    ...
    MDL_NO_TAB_PANEL: 'mdl-js-no-tab-panel'
};
/**
...
function MaterialTab(tab, ctx) {
    if (tab) {
        ...
        tab.addEventListener('click', function (e) {
            ...
            if(!tab.classList.contains(ctx.CssClasses_.MDL_NO_TAB_PANEL)){
...
function MaterialLayoutTab(tab, tabs, panels, layout) {
    if (tab) {
        ...
        tab.addEventListener('click', function (e) {
        	/*
        	 * Deze check zorgt ervoor dat hij niet de panels probeert te activaten
        	 * tab knopje moet dan wel deze class hebben
        	 */
            if(!tab.classList.contains('mdl-js-no-tab-panel')){
	            e.preventDefault();
